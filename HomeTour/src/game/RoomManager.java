...
// startingRoom object	
	...
	public void init() {
		...
		Room secondFloor = new Room("The Second Floor", "The Second Floor large with a Bedroom and Balcony",
				"The large space enough to fit 2 couches and a loveseat.\n"
						+ "To the east there is bedroom and to the north is the balcony.");
		...
		Room garage = new Room("The Garage", " A large car space with Garage ",
				"The large carspace enough to fit 6 cars with a noth facing Garage door.\n"
						+ "To the south there is door leading up the stair case to the first floor.\n"
		...
		Items chair = new Items("Chair", "The Home Theater Reclining Chair",
				"This recliner chair is fashion and simple imparted an air of elegance to the room."
						+ "Built-in springs in both of back and seat with overstuffed padding");
		Items couch = new Items("The Couch", "The Second Floor Couch",
				"This couch is a three person leather couch that reclines with cup holders.\n"
						+ "The reclining features are automatic and has temperature controls as well");
		Items toilet = new Items("The Toilet", "The bathroom inside the Master bedroom",
				"This is where people can have their personal time");
		Items bed = new Items("The Bed", "The bed inside the Master bedroom",
				"This is where people can have their sleep");
